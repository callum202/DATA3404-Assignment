...
public class MostPopularAircraftTypes {
    public static void main(String[] args) throws Exception {
        ...
        DataSet<Tuple3<String, String, String>> aircraftDetails = env.readCsvFile(localAircraftDataDir)
        ...
        DataSet<Tuple2<String, String>> airlinesAndTailNumbers = usAirline.join(flights)
        ...
        DataSet<Tuple4<String, String, String, String>> airlinesAndAircraftDetails = airlinesAndTailNumbers.join(aircraftDetails)
        ...
        DataSet<Tuple5<String, String, String, String, Integer>> aircraftUsedCount = airlinesAndAircraftDetails.groupBy(1)// group the data by tailnumber 
        ...
        outputResults(aircraftUsedCountFive);
	...
	public static void outputResults(DataSet<Tuple2<String, ArrayList<Tuple2<String, String>>>> results) throws Exception{
        ...
        File outputFile = new File("/Users/callumvandenhoek/Google Drive/Uni/DATA3404/Assignment/Output/MostPopularAircraftTypesOutput.txt"); //Change this path to implement HDFS
